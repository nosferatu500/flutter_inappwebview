...
class URLRequestCachePolicy_ {
  ...
  static const USE_PROTOCOL_CACHE_POLICY = URLRequestCachePolicy_._internal(0);
  ...
  static const RELOAD_IGNORING_LOCAL_CACHE_DATA =
      URLRequestCachePolicy_._internal(1);

  ///Use existing cache data, regardless or age or expiration date, loading from originating source only if there is no cached data.
  static const RETURN_CACHE_DATA_ELSE_LOAD = URLRequestCachePolicy_._internal(
    2,
  );
  ...
  static const RETURN_CACHE_DATA_DONT_LOAD = URLRequestCachePolicy_._internal(
    3,
  );
  ...
  static const RELOAD_IGNORING_LOCAL_AND_REMOTE_CACHE_DATA =
      URLRequestCachePolicy_._internal(4);

  ///Use cache data if the origin source can validate it; otherwise, load from the origin.
  ///
  ///**NOTE**: Versions earlier than macOS 15, iOS 13, watchOS 6, and tvOS 13 don’t implement this constant.
  static const RELOAD_REVALIDATING_CACHE_DATA =
      URLRequestCachePolicy_._internal(5);
}
