...
class ModalTransitionStyle_ {
  ...
  static const COVER_VERTICAL = ModalTransitionStyle_._internal(0);
  ...
  static const FLIP_HORIZONTAL = ModalTransitionStyle_._internal(1);
  ...
  static const CROSS_DISSOLVE = ModalTransitionStyle_._internal(2);
  ...
  static const PARTIAL_CURL = ModalTransitionStyle_._internal(3);
}
