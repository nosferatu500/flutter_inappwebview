...
class TracingCategory_ {
  ...
  static const CATEGORIES_ALL = TracingCategory_._internal(1);
  ...
  static const CATEGORIES_ANDROID_WEBVIEW = TracingCategory_._internal(2);
  ...
  static const CATEGORIES_FRAME_VIEWER = TracingCategory_._internal(64);

  ///Predefined set of categories for analyzing input latency issues.
  ///Typically includes "input", "renderer.scheduler" categories.
  static const CATEGORIES_INPUT_LATENCY = TracingCategory_._internal(8);
  ...
  static const CATEGORIES_JAVASCRIPT_AND_RENDERING = TracingCategory_._internal(
    32,
  );

  ///Indicates that there are no predefined categories.
  static const CATEGORIES_NONE = TracingCategory_._internal(0);

  ///Predefined set of categories for analyzing rendering issues.
  ///Typically includes "blink", "compositor" and "gpu" categories.
  static const CATEGORIES_RENDERING = TracingCategory_._internal(16);
  ...
  static const CATEGORIES_WEB_DEVELOPER = TracingCategory_._internal(4);
}
