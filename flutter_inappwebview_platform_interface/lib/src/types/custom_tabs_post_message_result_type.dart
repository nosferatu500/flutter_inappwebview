...
class CustomTabsPostMessageResultType_ {
  ...
  static const SUCCESS = CustomTabsPostMessageResultType_._internal(0);
  ...
  static const FAILURE_DISALLOWED = CustomTabsPostMessageResultType_._internal(
    -1,
  );
  ...
  static const FAILURE_REMOTE_ERROR =
      CustomTabsPostMessageResultType_._internal(-2);
  ...
  static const FAILURE_MESSAGING_ERROR =
      CustomTabsPostMessageResultType_._internal(-3);
}
