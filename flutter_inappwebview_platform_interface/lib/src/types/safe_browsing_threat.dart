...
class SafeBrowsingThreat_ {
  ...
  static const SAFE_BROWSING_THREAT_UNKNOWN = SafeBrowsingThreat_._internal(0);

  ///The resource was blocked because it contains malware.
  static const SAFE_BROWSING_THREAT_MALWARE = SafeBrowsingThreat_._internal(1);

  ///The resource was blocked because it contains deceptive content.
  static const SAFE_BROWSING_THREAT_PHISHING = SafeBrowsingThreat_._internal(2);

  ///The resource was blocked because it contains unwanted software.
  static const SAFE_BROWSING_THREAT_UNWANTED_SOFTWARE =
      SafeBrowsingThreat_._internal(3);
  ...
  static const SAFE_BROWSING_THREAT_BILLING = SafeBrowsingThreat_._internal(4);
}
