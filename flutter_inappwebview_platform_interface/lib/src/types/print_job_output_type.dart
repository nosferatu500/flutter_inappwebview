...
class PrintJobOutputType_ {
  ...
  static const GENERAL = PrintJobOutputType_._internal(0);
  ...
  static const PHOTO = PrintJobOutputType_._internal(1);
  ...
  static const GRAYSCALE = PrintJobOutputType_._internal(2);
  ...
  static const PHOTO_GRAYSCALE = PrintJobOutputType_._internal(3);
}
