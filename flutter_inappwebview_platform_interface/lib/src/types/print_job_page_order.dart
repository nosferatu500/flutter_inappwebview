...
class PrintJobPageOrder_ {
  ...
  static const DESCENDING = PrintJobPageOrder_._internal(-1);
  ...
  static const SPECIAL = PrintJobPageOrder_._internal(0);

  ///Ascending (back to front) page order.
  @EnumSupportedPlatforms(platforms: [EnumMacOSPlatform(value: 1)])
  static const ASCENDING = PrintJobPageOrder_._internal(1);

  ///No page order specified.
  @EnumSupportedPlatforms(platforms: [EnumMacOSPlatform(value: 2)])
  static const UNKNOWN = PrintJobPageOrder_._internal(2);
}
