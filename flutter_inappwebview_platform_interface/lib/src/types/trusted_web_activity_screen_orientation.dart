...
class TrustedWebActivityScreenOrientation_ {
  ...
  static const DEFAULT = TrustedWebActivityScreenOrientation_._internal(0);
  ...
  static const PORTRAIT_PRIMARY =
      TrustedWebActivityScreenOrientation_._internal(1);
  ...
  static const PORTRAIT_SECONDARY =
      TrustedWebActivityScreenOrientation_._internal(2);
  ...
  static const LANDSCAPE_PRIMARY =
      TrustedWebActivityScreenOrientation_._internal(3);
  ...
  static const LANDSCAPE_SECONDARY =
      TrustedWebActivityScreenOrientation_._internal(4);
  ...
  static const ANY = TrustedWebActivityScreenOrientation_._internal(5);
  ...
  static const LANDSCAPE = TrustedWebActivityScreenOrientation_._internal(6);
  ...
  static const PORTRAIT = TrustedWebActivityScreenOrientation_._internal(7);
  ...
  static const NATURAL = TrustedWebActivityScreenOrientation_._internal(8);
}
