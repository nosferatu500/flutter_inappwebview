...
object InterceptAjaxRequestJS {

  @JvmField
  val INTERCEPT_AJAX_REQUEST_JS_PLUGIN_SCRIPT_GROUP_NAME: String = "IN_APP_WEBVIEW_INTERCEPT_AJAX_REQUEST_JS_PLUGIN_SCRIPT"
  @JvmStatic
  ...
  fun FLAG_VARIABLE_FOR_ON_AJAX_READY_STATE_CHANGE(): String =
    JavaScriptBridgeJS.get_JAVASCRIPT_BRIDGE_NAME() + "._useOnAjaxReadyStateChange"
  @JvmStatic
  fun FLAG_VARIABLE_FOR_ON_AJAX_PROGRESS(): String =
    JavaScriptBridgeJS.get_JAVASCRIPT_BRIDGE_NAME() + "._useOnAjaxProgress"
  @JvmStatic
  ...
  @JvmStatic
  fun INTERCEPT_AJAX_REQUEST_JS_PLUGIN_SCRIPT(allowedOriginRules: Set<String>?, forMainFrameOnly: Boolean, initialUseOnAjaxReadyStateChange: Boolean, initialUseOnAjaxProgress: Boolean): PluginScript =
    PluginScript(
  ...
  @JvmStatic
  fun INTERCEPT_AJAX_REQUEST_JS_SOURCE(initialUseOnAjaxReadyStateChange: Boolean, initialUseOnAjaxProgress: Boolean): String =
    "(function(ajax) {" +
