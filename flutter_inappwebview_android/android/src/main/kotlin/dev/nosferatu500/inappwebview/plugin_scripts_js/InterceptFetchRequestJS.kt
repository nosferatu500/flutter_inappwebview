...
object InterceptFetchRequestJS {

  @JvmField
  val INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT_GROUP_NAME: String = "IN_APP_WEBVIEW_INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT"
  @JvmStatic
  ...
  @JvmStatic
  fun INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT(allowedOriginRules: Set<String>?, forMainFrameOnly: Boolean): PluginScript =
    PluginScript(
