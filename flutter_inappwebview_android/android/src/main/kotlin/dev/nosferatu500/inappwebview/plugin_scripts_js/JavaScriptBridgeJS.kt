...
object JavaScriptBridgeJS {
  private var _JAVASCRIPT_BRIDGE_NAME: String = "flutter_inappwebview"
  ...
  @JvmStatic
  fun get_JAVASCRIPT_BRIDGE_NAME(): String = _JAVASCRIPT_BRIDGE_NAME

  @JvmField
  val JAVASCRIPT_BRIDGE_JS_PLUGIN_SCRIPT_GROUP_NAME: String = "IN_APP_WEBVIEW_JAVASCRIPT_BRIDGE_JS_PLUGIN_SCRIPT"

  private const val VAR_JAVASCRIPT_BRIDGE_BRIDGE_SECRET = "\$IN_APP_WEBVIEW_JAVASCRIPT_BRIDGE_BRIDGE_SECRET"

  @JvmStatic
  fun JAVASCRIPT_BRIDGE_JS_PLUGIN_SCRIPT(expectedBridgeSecret: String, allowedOriginRules: Set<String>?, forMainFrameOnly: Boolean): PluginScript {
    val source = Util.replaceAll(JAVASCRIPT_BRIDGE_JS_SOURCE(), VAR_JAVASCRIPT_BRIDGE_BRIDGE_SECRET, expectedBridgeSecret)
    return PluginScript(
  ...
  fun JAVASCRIPT_UTIL_VAR_NAME(): String =
    "window." + get_JAVASCRIPT_BRIDGE_NAME() + "._Util"
  @JvmStatic
